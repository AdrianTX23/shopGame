          ...
          <div className={styles.globalFilters}>
               ...
               >
                 <button 
                   ...
                   style={{ backgroundColor: (hoverState[8].hovered || currentFilter == "Regalo") ? "#fff" : "#2d2d2d" }}
                   aria-label="Abrir Regalo"
                 >
                     <Wishlist 
                        style={{ fill: (hoverState[8].hovered || currentFilter == "Regalo") ? "#000000" : "#fff" }} 
               ...
               >
                 <button 
                   ...
                   style={{ backgroundColor: (hoverState[10].hovered || currentFilter == "Revisado") ? "#fff" : "#2d2d2d" }}
