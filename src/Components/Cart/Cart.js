                    ...
                    >
                        <div className={styles.top}>
                            <div className={styles.topHeader}>
                                <h2>{cartAmount >= 1 ? cartAmount > 1 ? `${cartAmount} Juegos` : "1 Juego" : "No Hay Juegos"}</h2>
                                <h3 onClick={clearCart}>{cartAmount >= 1 ? "Limpiar" : ""}</h3>
                            </div>
                                ...
                                {cart.map((item, i) => {
                                    return <motion.div 
                                            ...
                                            >
                                              ...
                                              <div>
                                                  ${item.price}
                                                  <button id={item.id} onClick={handleRemoveFromCart} className={styles.removeButton} aria-label="Cerrar">
