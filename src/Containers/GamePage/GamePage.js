                      ...
                      >
                        <AnimatedText>
                             <div className={textExtended ? styles.open : styles.closed}>
                                 <a href={selectedGame ? selectedGame.link : templateGame.link} target="_blank">{selectedGame ? selectedGame.name : "No"} SitioWeb</a>
                                 <h4>Liberado: {selectedGame ? selectedGame.release : templateGame.release}</h4>
                                 <h4>Plataforma: {selectedGame ? selectedGame.platforms : templateGame.platforms}</h4>
                                 <h4>Genero Pirincipal: {selectedGame ? selectedGame.genre : templateGame.genre}</h4>
                                 <h4>Desarrolladores: {selectedGame ? selectedGame.developers : templateGame.developers}</h4>
                                 <h4 className={styles.lastChild}>Editores: {selectedGame ? selectedGame.publishers : templateGame.publishers}</h4>
                             </div>
                        </AnimatedText>
