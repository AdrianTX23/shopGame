                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        <div className={styles.splash}>
                          <h1>Pickshoping</h1>
                          <p className={styles.intro}>El mejor destino para comprar juegos nuevos a precios competitivos. Soporte 24 horas, garantía de "mejor precio" <span className={styles.here}>A </span> — Continuacion mira nuestro catalogo <span className={styles.careers}>"Tu mejor opcion".</span></p>
                        </div>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="https://github.com/AdrianTX23" target="_blank"><button className={styles.cta} aria-label="View Repository">
                                <GitHubLogo className={styles.ctaSVG} />
                                GitHub
                              </button></a>
                              <a href="https://www.linkedin.com/in/adrian-gabriel-pico-martinez-68a25b210/?originalSubdomain=co" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open LinkedIn">
